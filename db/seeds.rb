...
Question.create(name_pt:'Quanto custa uma festa?', name_en:'Os preços variam consoante o tipo de evento, atividades praticadas e alojamento. E empresa criou diversos pacotes, adaptados a vários gostos e com diversas opções para que assim se adeque a todos os orçamentos.
Fora dos pacotes oferecidos também é possível personalizar-los, sob orçamento.',
	answer_pt:'How much will a party cost me?', answer_en:'The prices differ depending on the type of event, performed activities and accommodation. We created several packages, adapted to various tastes and with diverse options that can fit any budget.
